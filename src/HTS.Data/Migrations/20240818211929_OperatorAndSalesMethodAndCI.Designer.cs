...
namespace HTS.Data.Migrations
{
    ...
    [Migration("20240818211929_OperatorAndSalesMethodAndCI")]
    partial class OperatorAndSalesMethodAndCI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTS.Data.Entity.FinalizationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HTS.Data.Entity.HTSTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HTS.Data.Entity.HospitalAgentNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HospitalAgentNotes");
                });

            modelBuilder.Entity("HTS.Data.Entity.HospitalAgentNoteStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HospitalAgentNoteStatuses");
                });
            ...
            modelBuilder.Entity("HTS.Data.Entity.HospitalInterpreter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HospitalInterpreters");
                });
            ...
            modelBuilder.Entity("HTS.Data.Entity.InterpreterAppointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SalesMethodAndCompanionInfoId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SalesMethodAndCompanionInfoId");

                    b.ToTable("InterpreterAppointments");
                });

            modelBuilder.Entity("HTS.Data.Entity.InvitationLetterDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("InvitationLetterDocuments");
                });
            ...
            modelBuilder.Entity("HTS.Data.Entity.Patient", b =>
                {
                    ...
                    b.Property<bool?>("NoTreatmentPlan")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HTS.Data.Entity.PatientTreatmentProcess", b =>
                {
                    ...
                    b.Property<string>("FinalizationDescription")
                        .HasColumnType("text");

                    b.Property<int?>("FinalizationTypeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HTS.Data.Entity.SalesMethodAndCompanionInfo", b =>
                {
                    ...
                    b.Property<bool>("AdvancePaymentRequested")
                        .HasColumnType("boolean");

                    b.Property<bool>("AnyInvitationLetter")
                        .HasColumnType("boolean");

                    b.Property<bool>("AnyTravelPlan")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("IsDocumentTranslationRequired")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("TurkeyDestination")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("HTS.Data.Entity.TaskType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HTS.Data.Entity.HTSTask", b =>
                {
                    ...
                    b.HasOne("HTS.Data.Entity.TaskType", "TaskType")
                        .WithMany()
            ...
            modelBuilder.Entity("HTS.Data.Entity.HospitalAgentNote", b =>
                {
                    ...
                    b.HasOne("HTS.Data.Entity.HospitalAgentNoteStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("HTS.Data.Entity.InterpreterAppointment", b =>
                {
                    b.HasOne("HTS.Data.Entity.Branch", "Branch")
                        .WithMany("InterpreterAppointments")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HTS.Data.Entity.SalesMethodAndCompanionInfo", "SalesMethodAndCompanionInfo")
                        .WithMany("InterpreterAppointments")
                        .HasForeignKey("SalesMethodAndCompanionInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Branch");

                    b.Navigation("SalesMethodAndCompanionInfo");
                });
            ...
            modelBuilder.Entity("HTS.Data.Entity.InvitationLetterDocument", b =>
                {
                    ...
                    b.HasOne("HTS.Data.Entity.SalesMethodAndCompanionInfo", "SalesMethodAndCompanionInfo")
                        .WithMany("InvitationLetterDocuments")
                        .HasForeignKey("SalesMethodAndCompanionInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HTS.Data.Entity.PatientTreatmentProcess", b =>
                {
                    ...
                    b.HasOne("HTS.Data.Entity.FinalizationType", "FinalizationType")
                        .WithMany("PatientTreatmentProcesses")
                        .HasForeignKey("FinalizationTypeId");
            ...
            modelBuilder.Entity("HTS.Data.Entity.Branch", b =>
                {
                    b.Navigation("InterpreterAppointments");
                });
            ...
            modelBuilder.Entity("HTS.Data.Entity.Hospital", b =>
                {
                    b.Navigation("HospitalInterpreters");
            ...
            modelBuilder.Entity("HTS.Data.Entity.HospitalResponse", b =>
                {
                    b.Navigation("HospitalAgentNotes");
            ...
            modelBuilder.Entity("HTS.Data.Entity.SalesMethodAndCompanionInfo", b =>
                {
                    ...
                    b.Navigation("InvitationLetterDocuments");
                });
